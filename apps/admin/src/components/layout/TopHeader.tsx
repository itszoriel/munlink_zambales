      ...
      <div className="h-full px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="flex-1 max-w-xl mx-4 md:mx-8 hidden md:block">
          <div className="relative">
            <input type="search" name="admin_global_search" id="admin-global-search" aria-label="Search residents, requests, and items" placeholder="Search residents, requests, items..." className="w-full pl-10 pr-4 py-2 bg-neutral-50 border border-neutral-200 rounded-xl text-sm focus:outline-none focus:border-ocean-500 focus:ring-2 focus:ring-ocean-500/20 transition-all" />
